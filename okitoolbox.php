...
public class okitoolbox {
    ...
    $TRChars            = array("þ", "Þ", "ç","Ç","ö","Ö","ü","Ü","ð","Ð","ý","Ý","i","I");  
	...
	private function tr_money_to_string($money,$input_format=0){
		$arr1 = array("","Bir","Ýki","Üç","Dört","Beþ","Altý","Yedi","Sekiz","Dokuz");
		$arr10 = array("","On","Yirmi","Otuz","Kýrk","Elli","Atmýþ","Yetmiþ","Seksen","Doksan");
		$arr100 = array("","Yüz","ÝkiYüz","ÜçYüz","DörtYüz","BeþYüz","AltýYüz","YediYüz","SekizYüz","DokuzYüz");
		...
		if(substr($money_part1[1],0,1)==0 and substr($money_part1[1],1,1)==0){
			...
			$output.='Lira'.$arr10[substr($money_part1[1],0,1)].$arr1[substr($money_part1[1],1,1)].'Krþ';
		} 
		return $output;
	}
	...
	private function replace_html_turkish($text){
		$chararr=array('&#304;'=>'Ý','&#305;'=>'ý','&#231;'=>'ç','&#286;'=>'Ð','&#287;'=>'ð','&#199;'=>'Ç','&#351;'=>'þ','&#350;'=>'Þ','&Uuml;'=>'Ü','&uuml;'=>'ü','&Ouml;'=>'Ö','&ouml;'=>'ö');
